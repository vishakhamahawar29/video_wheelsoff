...
const connectOptions = {
  ...
  // maxAudioBitrate: maxaudiobitrate.value? [maxaudiobitrate.value]:[],
  // maxVideoBitrate: maxvideobitrate.value? [maxvideobitrate.value]:[],
...
async function selectAndJoinRoom(error = null) {
  ...
  try {
    ...
    // connectOptions.maxAudioBitrate = audioBitrateSelector.value
    // ? Number(audioBitrateSelector.value)
    // : null;

    // connectOptions.maxVideoBitrate = videoBitrateSelector.value
